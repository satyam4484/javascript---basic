...
let lower = document.getElementById('lowerdata');
let upper = document.getElementById('upperdata');
function cleardata() {
    lower.textContent = 0;
    upper.textContent = 0;
}
...
function Evaluate() {
    lower.textContent = eval(upper.textContent);
}

// document.body.addEventListener('mousem',function(e) {
//     window.body.style.backgroundColor =`rgb(${e.clientX/e.clientY},${e.clientY*e.clientX},${e.clientX*e.clientY})`;
